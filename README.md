# gokrb5
[![Version](https://img.shields.io/github/release/hashicorp/gokrb5.svg)](https://github.com/hashicorp/gokrb5/releases)

[![GoDoc](https://godoc.org/github.com/hashicorp/gokrb5?status.svg)](https://godoc.org/github.com/hashicorp/gokrb5) [![Go Report Card](https://goreportcard.com/badge/github.com/hashicorp/gokrb5)](https://goreportcard.com/report/github.com/hashicorp/gokrb5) [![Build Status](https://travis-ci.org/hashicorp/gokrb5.svg?branch=master)](https://travis-ci.org/hashicorp/gokrb5)
...
```
go get -d github.com/hashicorp/gokrb5/...
```
To import this package, add the following line to your code:
```go
import "github.com/hashicorp/gokrb5/<sub package>"
```
...
## Contributing
If you are interested in contributing to gokrb5, great! Please read the [contribution guidelines](https://github.com/hashicorp/gokrb5/blob/master/CONTRIBUTING.md).
...
```go
import "github.com/hashicorp/gokrb5/config"
...
```go
import 	"github.com/hashicorp/gokrb5/keytab"
...
```go
import 	"github.com/hashicorp/gokrb5/client"
...
```go
import 	"github.com/hashicorp/gokrb5/service"
...
[contribution guide](https://github.com/hashicorp/gokrb5/blob/master/CONTRIBUTING.md) as it should help you get started.
